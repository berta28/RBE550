...
class Case:
    ...
    @staticmethod
    def read(file, vehicle):
        case = Case(vehicle=vehicle)
        with open(file, 'r') as f:
            ...
            case.xmin = min(case.x0, case.xf) - 4
            case.xmax = 20
            case.ymin = -1
            case.ymax = max(case.y0, case.yf) + 4
...
class Map:
    def __init__(self,
        ...
        self.case = Case.read(file,vehicle=vehicle)
